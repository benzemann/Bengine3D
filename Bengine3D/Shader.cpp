...
void Shader::loadShader(){
	...
	shadowTextureUniform2 = glGetUniformLocation(shaderProgram, "shadowTexture2");
	lightConeAngleUniform = glGetUniformLocation(shaderProgram, "lightConeAngle");
	lightDirUniform = glGetUniformLocation(shaderProgram, "lightDirection");
	...
	isTexturedUniform = glGetUniformLocation(shaderProgram, "isTextured");
	...
	texScaleUniform = glGetUniformLocation(shaderProgram, "texScale");
